...
class DataServisPanggilanController extends Controller
{
/**
    ...
    {
        return view('dataservispanggilan',[
            'servis_panggilan'=> ServisPanggilan::paginate(10)
        ]);
    }
    public function show($id)
    {
        $cek=ServisPanggilan::where('id', $id)->first();
        return view('dataservispanggilan', [
            'servis_panggilan' => $cek,
        ]);
    }
    /**
