<div class="leftside-menu">
    ...
    <div class="h-100" id="leftside-menu-container" data-simplebar="">
        ...
        <ul class="side-nav">
            ...
            <li class="side-nav-item">
                <a  href="/hendraapp_gigi" aria-expanded="false" aria-controls="sidebarDashboards" class="side-nav-link">
                    <br><i class="uil-home-alt" href="/hendraapp_gigi"></i>
                    <span class="badge bg-success float-end" href="/hendraapp_gigi"></span>
